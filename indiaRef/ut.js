class UT{
    constructor(){
        ...
        this.back  = createButton('NEXT');
        this.back.position(displayWidth/2+800,displayHeight-100);
        this.back.style('background','skyBlue');
        this.back.style('width','200px');
        this.back.style('height','20px');
    }
    display(){
        this.title1.position(displayWidth/2+400,30);
        this.title2.position(displayWidth/2+500,80);
        this.title1.html("UNION");
        this.title2.html("TERRITORIES");
        this.button1.position(displayWidth/2-200,430);
        this.button2.position(displayWidth/2+600,430);
        this.button3.position(displayWidth/2+600,580);
        this.button4.position(displayWidth/2+600,480);
        this.button5.position(displayWidth/2-200,530);
        this.button6.position(displayWidth/2+600,530);
        this.button7.position(displayWidth/2-200,580);
        this.button8.position(displayWidth/2-200,480);
