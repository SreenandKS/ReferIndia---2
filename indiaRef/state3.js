class S3{
    ...
    display(){
        ...
        this.title.html("ARUNACHAL PRADESH");
        this.opt1 = createElement('h1.5');
        this.opt1.position(displayWidth/2+10,150);
        this.opt1.html("ARUNACHAL PRADESH'S CAPITAL IS ITANAGAR");
        ...
        this.opt3.html("ITS AREA IS 83,740 km²");
        this.opt4 = createElement('h1.5');
        this.opt4.position(displayWidth/2+10,450);
        this.opt4.html("ITS POPULATION IS ABOUT 1.255 million");
        this.opt5 = createElement('h1.5');
        this.opt5.position(displayWidth/2+10,550);
        this.opt5.html("FESTIVAL CELEBRATED ARE SOLUNG,NYOKUM,LOKU,SANKEN");
        this.opt6 = createElement('h1.5');
        this.opt6.position(displayWidth/2+10,650);
        this.opt6.html("AJI LAMU DANCE IS A FAMOUS DANCE FORM AT ARUNACHAL PRADESH");
        back.show();
