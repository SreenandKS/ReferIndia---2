class U1{
    ...
    display(){
        ...
        this.title.html("ANDAMAN AND NICOBAR ISLANDS");
        this.opt1 = createElement('h1.5');
        this.opt1.position(displayWidth/2+10,150);
        this.opt1.html("ITS CAPITAL IS PORT BLAIR");
        ...
        this.opt3.html("ITS AREA IS 8,249 km²");
        this.opt4 = createElement('h1.5');
        this.opt4.position(displayWidth/2+10,450);
        this.opt4.html("ITS POPULATION IS ABOUT 3.8 LAKHS");
