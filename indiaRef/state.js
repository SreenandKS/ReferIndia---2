class State{
    ...
    display(){
        ...
        this.title1.position(displayWidth/2+300,displayHeight/2-300);
        this.title1.html("STATES OF");
        this.title1.style('color','purple');
        this.title2.position(displayWidth/2+400,displayHeight/2-270);
       ...
       this.back.mousePressed(()=>{
           ...
           back.hide();
            ...
            this.button28.hide();
              form.ut.show();
                form.ut.position(displayWidth/2+300,displayHeight/2);
                form.ut.style('background','lightGreen');
                form.ut.style('width','300px');
                form.ut.style('height','30px');

                  form.ut.mousePressed(()=>{
