class Form{
    ...
    display(){
        ...
        this.title1.position(displayWidth/2-100,displayHeight/2+200);
        this.title1.html("PROUD TO BE ");
        this.title1.style('color','orange');
        this.title1.style('font','Calibri');
        this.title1.style('fontSize','70px')
        this.title2.position(displayWidth/2+400,displayHeight/2+200);
        this.title2.html("AN  INDIAN");
        this.title2.style('color','lightGreen');
        this.title2.style('font','Calibri');
        this.title2.style('fontSize','70px')
        this.opt1.position(displayWidth/2+120,displayHeight/2-350);
        this.opt2.position(displayWidth/2+120,displayHeight/2-330);
        this.opt3.position(displayWidth/2+120,displayHeight/2-310);
        this.opt4.position(displayWidth/2+120,displayHeight/2-290);
        this.opt5.position(displayWidth/2+120,displayHeight/2-270);
        this.opt6.position(displayWidth/2+120,displayHeight/2-250);
        this.opt7.position(displayWidth/2+120,displayHeight/2-230);
        this.opt8.position(displayWidth/2+120,displayHeight/2-210);
        this.opt9.position(displayWidth/2+120,displayHeight/2-190);
        this.opt10.position(displayWidth/2+120,displayHeight/2-170);
